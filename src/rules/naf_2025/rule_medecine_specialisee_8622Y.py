"""
    Assign NAF 2025 codes for data specialty medicine.
...
@rule(
    name="specialty_medicine_assignment_2025",
    tags=["naf_2025"],
    description="Règle médecine spécialisée version NAF 2025",
)
@track_changes(column=NACE_REV2_1_COLUMN)
def specialty_medicine_rule_8622Y_2025(df: pd.DataFrame,
                                       methods=None,
