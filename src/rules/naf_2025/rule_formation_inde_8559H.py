"""
    Assign NAF 2025 codes for other independant teaching.
...
@rule(
    name="other_independant_teaching_assignment_2025",
    tags=["naf_2025"],
    description="Règle formation indépendante version NAF 2025",
)
@track_changes(column=NACE_REV2_1_COLUMN)
def other_independant_teaching_rule_8559H_2025(df: pd.DataFrame,
                                               methods=None,
    ...
    df[NACE_REV2_1_COLUMN] = np.where(match_mask, "8559H", df[NACE_REV2_1_COLUMN])
