...
def similarity_mask(
    ...
    term_vecs = normalize(model.encode(terms, convert_to_numpy=True, batch_size=40000), axis=1)
    text_vecs = normalize(model.encode(texts, convert_to_numpy=True, batch_size=40000), axis=1)
