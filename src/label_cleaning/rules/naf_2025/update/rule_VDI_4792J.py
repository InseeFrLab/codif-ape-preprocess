...
def door2door_selling_4792J_2025(
    ...
    terms = [
        ...
        "vente à distance sur catalogue specialise",
        "vdi",
        "vdi vente a domicile",
        "vente a domicile vdi",
        "vdi vente a domicile societe",
        "vdi vente a domicile independant",
        "vente à domicile vdi",
        "vdi vente à domicile societe",
        "vdi vente à domicile independant",
        "vdi sans stock",
        ...
        "vente a domicile",
        "vendeur à domicile",
        "vendeur à domicile independant",
        "vente à domicile sous statut vdi",
        "vente à domicile",
        "vendeur à domicile",
        "vendeur à domicile independant",
    ]
